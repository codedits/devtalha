...
export const SECTION_CONFIGS: SectionConfig[] = [
  ...
  },
  {
    ...
    description: "Main hero banner - heading, background media (image/video), overlay brightness, and name label.",
    fields: [
      { key: "heading", label: "Heading", type: "textarea", placeholder: "Main hero heading text" },
      {
        ...
        type: "select",
        description: "Choose whether to display an image or video as background.",
        options: [
          { label: "Image", value: "image" },
          { label: "Video", value: "video" },
        ],
      },
      { key: "background_image_url", label: "Desktop Background", type: "media" },
      { key: "mobile_background_image_url", label: "Mobile Background", type: "media" },
      { key: "media_url", label: "Background Video", type: "media", placeholder: "Upload or paste video URL" },
      {
        key: "overlay_opacity",
        label: "Overlay Opacity (Darkness)",
        type: "range",
        description: "Adjust overlay darkness on top of background media. 0% is fully bright, 100% is fully dark.",
        min: 0,
        max: 100,
        step: 5,
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "studio_image_url", label: "Studio Media", type: "media" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "image_url", label: "Main Media", type: "media" },
      { key: "hover_image_url", label: "Hover Media", type: "media" },
      { key: "gallery_images", label: "Detail Gallery", type: "media-list" },
      {
        key: "scope",
        label: "Project Scope",
        type: "scope",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "images", label: "Media", type: "media-list" },
      { key: "sort_order", label: "Sort Order", type: "number" },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "heading", label: "Heading", type: "textarea", placeholder: "Creative solutions for ambitious brands" },
      { key: "profile_image_url", label: "Profile Media", type: "media" },
  ...
  },
  {
    ...
    mode: "single",
    icon: <ImageIcon size={18} />,
    description: "Introductory section displaying preliminary text and a full viewport concept background (image/video).",
    fields: [
      { key: "label", label: "Section Label", type: "text", placeholder: "[ DESIGN & DEVELOPMENT ]" },
      { key: "heading", label: "Heading", type: "textarea", placeholder: "Designing. \nCoding. \nElevating Experience." },
      { key: "description", label: "Description", type: "textarea", placeholder: "Merging technical precision..." },
      { key: "image_url", label: "Media Background", type: "media" },
    ],
  },
  {
    title: "Process",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "background_image_url", label: "Background Media", type: "media" },
