    ...
    >
      ...
      <motion.path
        d="M9.5,137.3c5.1-10.7,15.1-18.6,26-23c11-4.4,23-5.7,34.8-5.8c36.7-0.3,73.3,10.2,109.6,5.4
			...
			c1.9,5.5,2.4,11.4,4.1,16.9c1.6,5.6,4.6,11.1,9.8,13.8c8,4.3,17.6,0.2,24.8-3.8c-1.7,0.9-3.3,1.9-5,2.8"        className="stroke-black dark:stroke-white [stroke-width:9] md:[stroke-width:7]"
        strokeLinecap="round"
